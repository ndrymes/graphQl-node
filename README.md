...
The goal of this exercise is to create an API Client + Server using Node and GraphQL.

### The Task

In this task, we are building the full stack of an application that helps us managing our team using GraphQL.
...
We need to offer a GraphQL CRUD for all the information above.
